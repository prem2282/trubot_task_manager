...
|----|--------|---------|-------|------|
| BUG-001 | Fixed | Docker daemon not running (Colima) | 2026-06-06 | [BUG-001](./bugs/BUG-001-docker-daemon-not-running-colima.md) |
| BUG-002 | Fixed | Vite UI fails on Node 16 (`getRandomValues`) | 2026-06-07 | [BUG-002](./bugs/BUG-002-vite-fails-node16-crypto-getrandomvalues.md) |
